...
Corresponding Paper: Dautle, M., Zhang, S., Chen, Y. (2023). scTIGER: a Deep-Learning Method for Inferring Gene Regulatory Networks from Case versus Control scRNA-seq Datasets. *Int. J. Mol. Sci.* (under review).  
