...
while args.start <= 3:
    if args.start == 1: 
        sd.SIDELINE(args.outputDir, args.runs, n, caseW, ctrlW, args.zeroThresh, geneList, allInteractions, args.topGenes, args.cuda, args.timeDelay)
        ...
        sd.BACKGROUND(args.outputDir, geneList, args.runs, caseW, ctrlW, n, args.zeroThresh, args.topGenes, args.cuda, args.timeDelay)
        args.start+=1
    elif args.start == 3:
        sd.GRAPH(args.outputDir, geneList, args.runs, args.timeDelay)
        args.start+=1
    else:
        args.start+=1
